...
class GameState {
  ...
  static const Map<int, EndingInfo> endingDetails = {
    ...
    8: EndingInfo(
      title: 'سجين التمثال',
      titleEn: 'Prisoner of the Statue',
