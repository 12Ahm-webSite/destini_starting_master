...
class AchievementsScreen extends StatelessWidget {
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildEndingCard(info, discovered);
                    },
                  ),
                ),
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildAchievementTile(achievement, unlocked);
                    },
                  ),
                ),
              ],
  ...
  Widget _buildEndingCard(EndingInfo info, bool discovered) {
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  unlocked ? achievement.description : 'لم يُكتشف بعد',
                  style: GoogleFonts.cairo(
                    fontSize: 12,
